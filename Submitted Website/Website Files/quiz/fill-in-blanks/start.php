...
<div class="container">
  ...
  <h1><?= h($quiz['title']) ?></h1>
  <div class="warning-box"><?= h($quiz['description'] ?: 'Drag words from the word bank to fill in the blanks correctly.') ?></div>
  <div class="info-card">
  ...
  <div class="info-card">
    ...
    <div class="info-row"><span class="info-key">Type</span><span class="info-val">Fill in the Blanks</span></div>
    <div class="info-row"><span class="info-key">Sentences</span><span class="info-val"><?= $totalSentences ?></span></div>
  ...
  <?php if ($attLeft <= 0): ?>
    ...
    <div class="actions"><a href="<?= SITE_ROOT ?>quiz/fill-in-blanks/results.php?quiz_id=<?= $quizId ?>" class="btn btn-primary">View Results</a></div>
  <?php else: ?>
    <div class="actions">
      <a href="<?= SITE_ROOT ?>class.php?id=<?= $quiz['class_id'] ?>" class="btn btn-secondary">← Back</a>
      <a href="<?= SITE_ROOT ?>quiz/fill-in-blanks/play.php?quiz_id=<?= $quizId ?>" class="btn btn-primary">Start Quiz →</a>
    </div>
  <?php endif; ?>
</div>
</body>
