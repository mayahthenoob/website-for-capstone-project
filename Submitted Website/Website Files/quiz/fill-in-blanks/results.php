...
body::before{content:'';position:fixed;inset:0;background-image:radial-gradient(1px 1px at 20% 30%,rgba(255,255,255,0.6) 0%,transparent 100%),radial-gradient(2px 2px at 50% 40%,rgba(0,210,255,0.3) 0%,transparent 100%);pointer-events:none;z-index:0;}
...
.fill-correct{stroke:url(#grad-correct);}.fill-speed{stroke:url(#grad-speed);}.fill-streak{stroke:url(#grad-streak);}
...
<div class="game-card">
  ...
  <div class="inner-frame">
    ...
    <div class="stats-grid">
      <div class="stat-box"><span class="stat-val" id="statBlanks">—</span><span class="stat-key">Correct Blanks</span></div>
  ...
  <div class="nav-buttons">
    ...
    <a href="<?= SITE_ROOT ?>quiz/fill-in-blanks/end.php?quiz_id=<?= $quizId ?>" class="btn">Details →</a>
  </div>
</div>
<script>
...
if (attempt) {
  ...
  const { correctPct = 0, timePct = 0, streakPct = 0, correct = 0, total = 0, durationSecs = 0 } = attempt;
  const mins = Math.floor(durationSecs / 60), secs = durationSecs % 60;
  document.getElementById("statBlanks").textContent = `${correct || attempt.score || 0} / ${total || attempt.max_score || 0}`;
