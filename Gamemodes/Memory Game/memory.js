...
const loadGame = (data) => {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        cardBx.innerHTML += `<div id="${data[i]['card_id']}" class="card" onclick="checkCard(${data[i]['card_id']}, ${data[i]['card_value']})">${frontCard}${backCard}</div>`;
    }
}
